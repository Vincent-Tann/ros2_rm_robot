...
def generate_launch_description():
    ...
    #     parameters=[{'robot_description': '/robot_description'}, '/home/txszju/Code/addx/ws_rm_robot/src/ros2_rm_robot/rm_moveit2_config/rm_65_config/config/ros2_controllers.yaml'],
    #     output='screen'
    # ) 
